...
<c:set var="path" value="${pageContext.request.contextPath}"/>
	...
	<jsp:include page="/WEB-INF/views/common/header.jsp">
      <jsp:param value="공연 리뷰글 작성" name="title"/>
    </jsp:include>
...
<html lang="en">
  ...
  <body style="padding-top: 72px;">
    ...
    <section>
      <div class="container">
        <form action="${path}/boardPrf/write" method="post" enctype="multipart/form-data">
        <!-- 이거 없으면 에러남 -->
              ...
              <div class="row">
                <div class="mb-3">
                  ...
                  <input type="text" class="form-control-lg gdodumfont w-100 form-control" id="eventname" 
                  			name="pname" value="${pname}" readonly placeholder="[뮤지컬] 몬테크리스토">
                </div>
              </div>
              <div class="row">
                <div class="mb-3">
