...
public class KakaoPayService {
	...
	public String kakaoPayReady(Map<String, String> param) {
		...
		params.add("approval_url", "http://localhost/semi/kakaoPaySuccess");
		params.add("cancel_url", "http://localhost/semi/kakaoPayCancel");
		params.add("fail_url", "http://localhost/semi/kakaoPaySuccessFail");
