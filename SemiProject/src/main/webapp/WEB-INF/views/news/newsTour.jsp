...
<c:set var="path" value="${pageContext.request.contextPath}"/>
    ...
    <jsp:include page="/WEB-INF/views/common/header.jsp">
      <jsp:param value="관광지 뉴스 검색" name="title"/>
    </jsp:include>
...
<!-- 공연 검색 폼 영역 시작 -->
<section class="hero-home dark-overlay"><img class="bg-image" src="${path}/resources/img/myImages/newsTourHero.jpg" alt="">
...
<div class="container">
   <form name="searchTourForm" action="${path}/news/tour" method="get">
...
<script type="text/javascript">
	function movePage(page){
		searchTourForm.page.value = page;
