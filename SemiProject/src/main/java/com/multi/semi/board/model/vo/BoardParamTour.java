...
public class BoardParamTour {
	...
	public BoardParamTour() {
		super();
		page = 1;
		orderType = "time";
	}

	public BoardParamTour(String searchType, String searchValue, int page, int limit, int offset, String orderType) {
		super();
