...
public class TourParam {
	...
	public TourParam(String searchType, String searchValue,String areaCodeValue, String[] types, int page, int limit,
			int offset) {
		super();
	...
	public String toString() {
		return "TourParam [searchType=" + searchType + ", searchValue=" + searchValue + ", areaCodeValue=" + areaCodeValue
				+ ", types=" + Arrays.toString(types) + ", typeList=" + typeList + ", page=" + page + ", limit=" + limit
				+ ", offset=" + offset + "]";
	}
