            ...
            <div class="card border-0 shadow">
              <div class="card-body p-4">
                <table class="w-100">
                  <tbody>
                    <tr>
                      <td rowspan="4"><img class="shadow" src="${prfItem.poster}" alt="MonteCristoPoster" height="220px"></td>
                      <td class="text-center">${ticket.pname}</td>
                    </tr>
                    <tr>
                      <td class="text-center">${ticket.reserveTime}</td>
                    </tr>
                    <tr>
                      <td class="text-center">${ticket.showTime}</td>
                    </tr>
                    <tr>
                      <td class="text-center">${ticket.seatType} ${ticket.seatCount}매</td>
                    </tr>
