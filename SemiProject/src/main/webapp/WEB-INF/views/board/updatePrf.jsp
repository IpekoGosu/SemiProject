...
<c:set var="path" value="${pageContext.request.contextPath}"/>
	...
	<jsp:include page="/WEB-INF/views/common/header.jsp">
      <jsp:param value="공연 리뷰글 수정" name="title"/>
    </jsp:include>
...
<html lang="en">
  ...
  <body style="padding-top: 72px;">
    ...
    <section>
      <div class="container">
        <form action="${path}/boardPrf/update" method="post" enctype="multipart/form-data">
        <!-- 이거 없으면 에러남 -->
        ...
        <input type="hidden" name="memberId" value="${board.memberId}">
          <div class="row mb-4">
            <div class="col-lg-7">
              <div class="row mb-2">
                ...
                <div class="col-lg-5">
                  ...
                  <select disabled id="writetypesel" class="form-select text-center form-select-lg w-100" size="2" multiple aria-label="writetypesel">
                    <option selected value="공연">공연</option>
              ...
              <div class="row">
                <div class="mb-3">
                  <label for="eventname" class="gmarketfontM">관람한 공연명</label>
                  <input type="text" class="form-control-lg gdodumfont w-100 form-control" id="eventname" 
                  			name="pname" value="${board.pname}" readonly placeholder="[뮤지컬] 몬테크리스토">
                </div>
              </div>
              <div class="row">
                <div class="mb-3">
                  ...
                  <input type="text" class="form-control-lg gdodumfont form-control" id="reviewname" 
                  			name="title" value="${board.title}" placeholder="제목 입력">
                </div>
              </div>
              <div class="row">
                <div>
