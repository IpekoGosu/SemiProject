...
<html lang="en">
  ...
  <body style="padding-top: 72px;">
    ...
    <section class="position-relative py-6"><img class="bg-image" src="${path}/resources/img/myImages/boardTourHero.jpg" alt="">
      <div class="container">
        <div class="row">
          <div class="col-lg-6">
            <div class="card">
              <div class="card-body p-5"><strong class="text-uppercase text-secondary d-inline-block mb-2 text-sm gmarketfontM">인기 후기</strong>
                ...
                <a class="btn btn-link p-0 gmarketfontM" href="${path}/boardTour/view?no=${firstBoard.bno}">계속 읽기<i class="fa fa-long-arrow-alt-right"></i></a>
              </div>
            </div>
          </div>
        </div>
    ...
    <section class="py-6">
      <div class="container">
       ...
       <form name="searchBoardTourFrom" action="${path}/boardTour/list" method="get">
              ...
              <table class="w-100">
                <tbody>
                  <tr>
                    ...
                    <td>
                      <input type="radio" name="searchType" value="tname" class="btn-check"
                      		 id="btn-check-outlined3" autocomplete="off" ${searchType == 'tname' ? 'checked' : ''}>
                      <label class="btn btn-outline-dark" for="btn-check-outlined3">&nbsp;&nbsp;&nbsp;관광지명&nbsp;&nbsp;&nbsp;</label>
                    </td>
                  </tr>
                </tbody>
              </table>
	        ...
	        <c:forEach items="${list}" var="item" varStatus="status">
	          ...
	          <div class="col-lg-4 col-sm-6 mb-4 hover-animate">
	            <div class="card shadow border-0 h-100">
	              <a href="${path}/boardTour/view?no=${item.bno}">
	              ...
	              <div class="card-body">
	                ...
	                <h5 class="my-2" style="height: 30px; overflow: hidden; text-overflow: ellipsis;">
	                	<a class="text-dark gmarketfontM" href="${path}/boardTour/view?no=${item.bno}">
	                ...
	                <div class="row">
		                ...
		                <a class="btn btn-link ps-0 gmarketfontM" href="${path}/boardTour/view?no=${item.bno}">
